...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  //0000000000000oooooooooooo Material Cristal oooooooooooo0000000
    ...
    G4ExtendedMaterial* Crystal =
        new G4ExtendedMaterial("crystal.material", TLD_LiF_Mn);
   ...
   //imprima Material
    ...
    crystalExtension->SetUnitCell(
				  new G4CrystalUnitCell(4.0351 * CLHEP::angstrom,
                                        4.0351 * CLHEP::angstrom,
                                        4.0351 * CLHEP::angstrom,
                                        CLHEP::halfpi,
                                        CLHEP::halfpi,
                                        CLHEP::halfpi,
    ...
    G4LogicalVolume* crystalLogic =
      new G4LogicalCrystalVolume(CrisSubtraction,
                                 Crystal, 
                                 "Crystal_logic");
    ...
    G4LogicalVolume* crystalLogic2 =
      new G4LogicalCrystalVolume(NucleoCristal,
                                 Crystal,
                                 "Crystal_logic2");
